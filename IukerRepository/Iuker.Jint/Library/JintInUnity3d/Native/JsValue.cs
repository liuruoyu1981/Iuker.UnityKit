...
namespace Jint.Native
{
    ...
    public class JsValue : IEquatable<JsValue>
    {
        ...
        #region Unity3d extension

        private ObjectInstance _instance;

        private ObjectInstance ToInstance
        {
            get
            {
                return _instance ?? (_instance = (ObjectInstance)_object);
            }
        }

        public JsValue GetJsValue(string name)
        {
            return ToInstance.Get(name);
        }
        ...
        public bool Equals(JsValue other)
        {
            ...
            switch (_type)
            {
                ...
                case Types.Boolean:
                case Types.Number:
                    return System.Math.Abs(_double - other._double) < 0;
                case Types.String:
                case Types.Object:
        ...
        public static JsValue FromObject(Engine engine, object value)
        {
            ...
            if (instance != null)
            {
                ...
                var newTypeMappers = new Dictionary<Type, Func<Engine, object, JsValue>>(typeMappers);
                newTypeMappers[valueType] = (Engine e, object v) => new JsValue((ObjectInstance)v);
                Interlocked.CompareExchange(ref Engine.TypeMappers, newTypeMappers, typeMappers);
            ...
            if (a != null)
            {
                ...
                var newTypeMappers = new Dictionary<Type, Func<Engine, object, JsValue>>(typeMappers);
                newTypeMappers[valueType] = convert;
                Interlocked.CompareExchange(ref Engine.TypeMappers, newTypeMappers, typeMappers);
        ...
        {
            return InvokeByThis(Undefined, arguments);
        }
        ...
        /// <param name="arguments">The arguments of the function call.</param>
        /// <returns>The value returned by the function call.</returns>
        public JsValue InvokeByThis(JsValue thisObj, params JsValue[] arguments)
        {
