...
namespace Jint.Runtime
{
    public class ExpressionInterpreter
    {
        ...
        public JsValue EvaluateCallExpression(CallExpression callExpression)
        {
            ...
            {
                throw new JavaScriptException(_engine.TypeError, r == null ? "" : string.Format(
                    "Object has no method '{0}'", r.GetReferencedName()));
            }
            ...
            if (!func.IsObject())
            {
                    ...
                    !_engine.Options._ReferenceResolver.TryGetCallable(_engine, callee, out func))
                {
                    throw new JavaScriptException(_engine.TypeError,
                        r == null ? "" : string.Format("Property '{0}' of object is not a function",
                            r.GetReferencedName()));
                }
            }
