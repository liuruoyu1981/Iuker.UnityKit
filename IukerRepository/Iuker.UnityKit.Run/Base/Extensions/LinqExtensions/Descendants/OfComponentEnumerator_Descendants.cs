/***********************************************************************************************
Author：liuruoyu1981
CreateDate: 2017/03/11 20:13:25
...
{
    public struct OfComponentEnumerator_Descendants<T> : IEnumerator<T> where T : Component
    {
        Enumerator_Descendants enumerator; // enumerator is mutable
        T current;
        ...
        public OfComponentEnumerator_Descendants(ref DescendantsEnumerable parent)
        {
