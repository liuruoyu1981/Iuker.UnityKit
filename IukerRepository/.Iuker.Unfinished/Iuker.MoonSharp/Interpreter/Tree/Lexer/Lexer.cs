/***********************************************************************************************
Author：liuruoyu1981
CreateDate: 2017/03/15 11:55:50
...
namespace Iuker.MoonSharp.Tree.Lexer
{
    /// <summary>
    /// 词法分析器
    /// </summary>
    class Lexer
    {
        ...
        /// 构建一个词法分析器的实例
        /// </summary>
        /// <param name="sourceID">源码ID</param>
        /// <param name="scriptContent">源码文本内容</param>
        /// <param name="autoSkipComments">是否自动跳过注释</param>
        public Lexer(int sourceID, string scriptContent, bool autoSkipComments)
        {
            m_Code = scriptContent;
            m_SourceId = sourceID;

            // 移除unicode 字节顺序标记（如果脚本源文件存在字节顺序标记的话）
