...
{
    public class ClassBody_ReturnType_Identifier_LeftBracket_ArgumentType : AbsSyntaxChecker
    {
        ...
        public override string ProcessedSituation { get; } =
            SyntaxSituation.ClassBody_ReturnType_Identifier_LeftBracket_ArgumentType;
    }
}
