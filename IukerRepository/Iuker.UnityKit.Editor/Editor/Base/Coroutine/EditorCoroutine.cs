...
namespace Iuker.UnityKit.Editor.Coroutine
{
    ...
    {
        private static EditorCoroutine instance = null;

        private readonly Dictionary<string, List<Coroutine>> coroutineDict = new Dictionary<string, List<Coroutine>>();
        private readonly Dictionary<string, Dictionary<string, Coroutine>> coroutineOwnerDict = new Dictionary<string, Dictionary<string, Coroutine>>();
