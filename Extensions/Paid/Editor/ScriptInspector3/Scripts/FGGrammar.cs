...
//					}
		...
		//	var idTypes = IdentifierCompletionsType.None;
			...
			//Debug.Log(tokenSet.ToString(FlipbookGames.ScriptInspector2.CsGrammar.GetInstance.GetParser));
	...
	public class Parser : Node
	{
		...
		public void InitializeGrammar()
		{
			...
			//    if (rule.lookahead.Matches(FlipbookGames.ScriptInspector2.CsGrammar.GetInstance.tokenIdentifier))
