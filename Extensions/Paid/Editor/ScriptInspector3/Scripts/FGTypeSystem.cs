...
public static class FGResolver
{
		...
		bool includeExtensionMethods)
	{
		if (targetDef != null)
		{
			...
			//targetDef.kind = targetDef is TypeDefinitionBase && targetDef.kind != SymbolKind.Enum ? BindingFlags.Static : targetDef is InstanceDefinition ? BindingFlags.GetInstance : 0;
